...
export const RoleData:SpawnConstantData = {
    ...
    'x-heal':{num:0,ability:[0,0,10,0,2,26,0,12],level:9,mark:"绿",must:true,mem:{creepType:'heal'}},
    'x-attack':{num:0,ability:[0,0,10,28,0,0,0,12],level:9,mark:"红",must:true,mem:{creepType:'attack'}},
    'x-range':{num:0,ability:[0,0,10,0,24,4,0,12],level:9,mark:"蓝",must:true,mem:{creepType:'attack'}},
